...
# esto de aquí arriba en mdx son como los metadatos pero que si quieres utilizarlos en el texto tienes que añadir el frontmatter.[elemento_a_utilizar]
...
{/_ <!-- Mostrar imagen --> _/}
{/_ <Image src="/images/post-01.png" width="350" alt="Explorando Funciones de ES6" /> _/}
